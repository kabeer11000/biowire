    ...
    <article className={post.isLargePreview ? `${styles.post} ${styles['post--full-width']}` : styles.post}>
      ...
      <div className={styles.text}>
        ...
        <div className={styles.meta}>
          <a className="avatar avatar--small avatar--circled" href="https://blog.kentcdodds.com/@kentcdodds"
             target="_blank" rel="noopener noreferrer">
            <img src={author.avatarUrl}/>
          </a>
          <div className={styles['sub-meta']}>
            <a className={styles.author} href="https://blog.kentcdodds.com/@kentcdodds" target="_blank"
